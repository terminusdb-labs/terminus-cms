...
export const CreateChangeRequestModal = ({showModal, setShowModal , setView}) => { 
    const nameRef = useRef(null);
    const messageRef = useRef(null);
    const {loading,errorMessage,setError,createChangeRequest} =  ChangeRequest(accessControlDashboard,{})
